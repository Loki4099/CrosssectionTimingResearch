...
| 研究主线 | 当前状态 | 入口 |
|---|---|---|
| 系统性 long-only 横截面 Alpha | **当前主线**。XA01–XA04已完成；统一模型比较没有产生可替代原始`XS003_MOM_12_7`的合格模型 | [主线主页](docs/research_tracks/cross_sectional_alpha.md) |
...
- 横截面下一阶段：按XA04机械分支，仅设计同样本`XS003_MOM_12_7`与冻结P00的迁移比较。新闻和文本由独立任务研究。
