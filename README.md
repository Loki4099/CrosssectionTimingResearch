...
| 研究主线 | 当前状态 | 入口 |
|---|---|---|
| 系统性 long-only 横截面 Alpha | **完整研究链已闭合至XA05**。MOM12-7仍是最佳裸信号；P00显著改善风险但牺牲Top20期末财富 | [主线主页](docs/research_tracks/cross_sectional_alpha.md) |
...
- 横截面最终证据：XA05已完成同样本`XS003_MOM_12_7`与冻结P00迁移；Top20呈现收益换风险，Top5在周/月均四项通过，但整体family gate失败。新闻和文本由独立任务研究。
